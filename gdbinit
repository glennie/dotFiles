...
document disr
Disassemble 10 lines before and 10 lines after the current execution point
Usage: disr
end
#}}}
...
document step_to_jump
This single steps until it encounters a jump instruction; it stops before
the jump is taken.
end
#}}}
